...
import { closeModal, openModal, setAdditionalOverlayVisibility } from "entities/ui/Modal/slice/modalSlice";
        ...
        return (
            <div className={styles.form}>
                <form onSubmit={formik.handleSubmit} className={styles.form__form}>
                    ...
                    {device !== 'mobile' && (
                        <div className={styles.adaptiv__wrapper}>
                            <div className={styles.adaptiv__container}>
                                <div className={styles.form__container__first}>
                                    <div className={styles.form__item}>
                                        <div className={styles.form__item__balans}>
                                            <span className={styles.balans}>Баланс портфеля</span>
                                            <Tooltip
                            ...
                            <div className={styles.adaptiv__container}>
                                <div className={styles.form__container__second}>
                                    <div className={styles.form__item}>
                                        <span className={styles.parametrs}>Параметры портфеля</span>
                                        <span className={styles.parametrs__value}>
                                            {SWIPER_PARAM_VALUES[formik.values.portfolio_parameters as keyof SwiperParametrValues]}
                                ...
                                {/* <h4 className={styles.title}>Завершение настроек риск профиля</h4> */}
                                <div className={styles.form__container__second} style={{ minHeight: '180px' }}>
                ...
                <WarningModal
                    ...
                    action={() => {
                        dispatch(setAdditionalOverlayVisibility(false))
                        dispatch(openModal({
